...
C_SOURCES += drivers/src/stm8s_clk.c # need to be enabled, if you want to use Serial Monitor
C_SOURCES += drivers/src/stm8s_delay.c # need to be enabled, if you want to use Serial Monitor
...
C_SOURCES += drivers/src/stm8s_tim3.c # need to be enabled, if you want to use Milis
